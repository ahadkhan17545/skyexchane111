...
const InstantworliMiddle = ({ marketData }) => {
  ...
  return (
    <div className="Middle-wraper Middle-wraper2">
      ...
      {marketData.map((market, marketIndex) => (
        <div className="marketScroll marketScroll3" key={marketIndex}>
          <div className="minMaxDesktop">
            <h4>{market.title}</h4>
          </div>
          <h4 className="MarketMinMax">Min/Max: {market.minMax}</h4>
          <div className={`market-inner market-inner3 ${market.title}`}>
            {market.players.map((player, playerIndex) => (
              <div
                className={`market-inner-item market-inner-item2 ${
              ...
              >
                <div className="market-item">
                  <div>
                    ...
                    {player.count &&(
                       <p className="player-count">{player.count}</p>
                    )}
...
export default InstantworliMiddle;
